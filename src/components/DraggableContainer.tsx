...
function DraggableContainer({ children }: { children: ReactNode }) {
  ...
  return (
    <motion.div
      className="w-full md:max-w-2xl lg:max-w-4xl 2xl:max-w-5xl h-[calc(100vh-100px)] sm:h-auto min-h-157.5 max-h-[calc(100dvh-100px)] md:max-h-200 rounded-xl border border-border shadow-xs flex flex-col items-center overflow-hidden"
      drag
